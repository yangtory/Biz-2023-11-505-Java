...
public class NumberB {
	 ...
	 * Java 에서는 같은 클래스 내에서 method(함수)의 이름을
	 * 중복하여 선언할수 있다
	 * 단, method 의 매개변수(arguments)의 
	 * 		1.개수가 다르거나,
	 * 		2.type 이 달라야 한다
	 * method 를 호출하는 곳에서 정의된 
	...
	public static void add() {
		System.out.println("나는 전달하는 값이 없어요");
	}
	 ...
	 * 코드는 아직 만들지 않았지만, method 는 선언된 상태
	...
	// return type 이 클래스가 아닌 경우(primitive 기본 type) 일 경우는
	// null 을 return 할수없다. 이때는 적절한 값을 return 해준다
	// 숫자형 일때는 보통 0 을 return 한다
