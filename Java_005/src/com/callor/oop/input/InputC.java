...
public class InputC {
	...
	public static void main(String[] args) {
		...
		num1 = Integer.parseInt(str1); //static method 이기때문에 class.하고 호출가능,이 안에서 Integer로 바꿔서 int 가 됨
		Float.parseFloat(str1);
								
		System.out.print("정수 2 >> ");
		String str2 = scan.nextLine();
		num2 = Integer.valueOf(str2); // 밖에서 int로 바꿈
		Float.valueOf(str2); // 앞의 클래스가 달라도 모두 valueOf
